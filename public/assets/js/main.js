$(document).ready(function () {
  ...
  $('input').keyup(function (e) {
    if (e.keyCode == 13) {
      ...
      const authorUser = $(this).data('author-user');
      ...
      $.ajax({
        ...
        success: function (data) {
          ...
          let contentComment =
            ...
            <img src="https://cdn.discordapp.com/avatars/${data.comment.authorId}/${data.comment.authorAvatar}" width="30"
              class="img-comment" alt="avatar">` +
            `<span class='author-comment'>${data.comment.authorUser}</span>` +

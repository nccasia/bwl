                        ...
                        >
                            <div className="list-post-author">
                                {state?.searchMessage !== item?.messageId ? (
                                    <NavigateBeforeIcon sx={{color: "#6C7588"}} className="list-icon" />
                                ):(
                                    <NavigateNextIcon sx={{color: 'rgb(25, 118, 210)' }} className="list-icon" />
                                )}
                                <img src={item?.source ? `https://bwl.vn/assets/images/${item?.links[0]}` : `https://bwl.vn/images/${item?.links[0]}`} />
                            </div>
                            <p style={{color: state?.searchMessage === item?.messageId ? "rgb(25, 118, 210" : "#6C7588"}}>{formatDay(item?.createdTimestamp?.$numberDecimal || item?.createdTimestamp)}</p>
                        </div>
                    )
                })
                : null}
